...
show_help() {
  cat <<'USAGE'
用法: kafuka/base/docker/alarm-consumer/build.sh [选项]

选项:
  -f, --file DOCKERFILE   指定 Dockerfile（默认 kafuka/base/docker/alarm-consumer/Dockerfile）
...
示例:
  ...
  kafuka/base/docker/alarm-consumer/build.sh -f kafuka/base/docker/alarm-consumer/Dockerfile -t alarm-consumer -p linux/arm64
USAGE
}

DOCKERFILE="kafuka/base/docker/alarm-consumer/Dockerfile"
TAG="alarm-consumer"
