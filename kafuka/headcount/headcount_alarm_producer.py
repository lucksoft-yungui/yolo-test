...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="手动推送人员数量检测图片到 Kafka")
    parser.add_argument(
        "--bootstrap-servers",
        type=str,
    ...
    parser.add_argument(
        "--image-dir",
        type=Path,
        default=Path("datasets/labcoat/images/train"),
        help="从目录递归收集 .jpg 图片，默认 datasets/labcoat/images/train",
    )
    parser.add_argument(
        "--limit",
        type=int,
